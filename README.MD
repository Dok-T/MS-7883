...
The last release is the version 0.3.6.
...
- Auto Power On when A/C is loss (for server server usage and make it HA)
...
- Some strings update
- Enabled PCH thermal monitoring device (not tested)
- **Fixed IOU String and Help (PCIe Bifurcation related) to match the correct slot of this motherboard!**
...
![Unlocked](https://github.com/Dok-T/MS-7883/blob/main/Screenshots/Unlocked.jpg?raw=true)

![IntelRCSetup](https://github.com/Dok-T/MS-7883/blob/main/Screenshots/MSI_SnapShot_11.jpg?raw=true)
